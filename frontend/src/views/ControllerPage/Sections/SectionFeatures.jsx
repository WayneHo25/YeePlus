      ...
      <GridContainer>
        <GridItem md={4} sm={4} className={classes.mlAuto}>
          <InfoArea
            ...
            description='YeePlus Controller comes bundled with PayPal (for accepting credit card and PayPal account payments), BACS, and cash on delivery for accepting payments.'
            icon={AttachMoney}
            iconColor='success'
          />
        </GridItem>
